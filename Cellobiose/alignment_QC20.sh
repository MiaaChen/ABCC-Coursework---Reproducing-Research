...
INPUT_DIR=/scratch/grp/msc_appbio/Group8_ABCC/Cellobiose/trimmed_result_threshold_20
OUTPUT_DIR=/scratch/grp/msc_appbio/Group8_ABCC/Cellobiose/alignment_result_QC20
