...
OUTPUT_DIR=/scratch/grp/msc_appbio/Group8_ABCC/Glucose/trimmed_result_threshold_20
FASTQC_POST=/scratch/grp/msc_appbio/Group8_ABCC/Glucose/fastqc_post_20
